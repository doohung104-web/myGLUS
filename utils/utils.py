...
SHORT_QUESTION_LIST = [
    ...
    DEFAULT_IMAGE_TOKEN + "\n" + "Please segment the {class_name} in this frame.",
    DEFAULT_IMAGE_TOKEN 
    + "\n"
    + "What is {class_name} in this frame? Please respond with segmentation mask.",
    DEFAULT_IMAGE_TOKEN 
    + "\n"
    + "What is {class_name} in this frame? Please output segmentation mask.",
]
