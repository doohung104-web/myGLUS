...
class LlavaMetaModel:
    def __init__(self, config):
        ...
        if hasattr(config, "mm_vision_tower"):
            ...
            self.downsample_layer = nn.AvgPool1d(kernel_size=4, stride=4)
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        ...
        # print("shape features", image_features.shape)
        
        image_features = image_features.permute(0, 2, 1)
        image_features = self.get_model().downsample_layer(image_features)
        image_features = image_features.permute(0, 2, 1)
        # print("shape features2", image_features.shape)
